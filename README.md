...
##### [YouTube video](https://www.youtube.com/watch?v=MPTmJTK-rVs "Youtube Nerd Autodidata") where the *source code* is explained. [Subscribe YouTube channel.](https://www.youtube.com/NerdAutodidata?sub_confirmation=1 "YouTube Subscribe Nerd Autodidata")  
<a href="https://www.youtube.com/watch?v=MPTmJTK-rVs&feature=player_embedded
" target="_blank"><img src="https://img.youtube.com/vi/MPTmJTK-rVs/maxresdefault.jpg" 
alt="With this project you will learn how to fetch JSON data from an API with search filter in Flutter using the http library." width="480" border="10" /></a>

➜&ensp;[Watch My Video](https://www.youtube.com/watch?v=MPTmJTK-rVs "Watch My Video")
